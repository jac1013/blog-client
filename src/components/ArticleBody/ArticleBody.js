...
const ArticleBody = () => {
  const input = '# This is a header\n\nThis is a paragraph, Alias architecto aut, consectetur earum est minus nesciuntssssssssssssssssssssssssssssssssssss nulla omnis? A alias dolor dolore dolores incidunt\n' +
